...
\begin{frame}{Section Overview}
  \begin{keybox}
    ...
    building blocks of all deep learning. Understanding how a single layer
    transforms inputs to outputs is a prerequisite for understanding LSTM
    and attention.
  \end{keybox}
\end{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.56\textwidth}
      \begin{definitionbox}{LSTM Gate Equations \parencite{Hochreiter1997}}
        ...
        Gates $f_t, i_t, o_t \in (0,1)^d$ are \emph{vectors} (one value per unit).
      \end{definitionbox}
    \end{column}
...
% -----------------------------------------------------------------------------
  ...
  \muted{\footnotesize\itshape
    ...
    What is the key difference between the two forms of regularization?}
\end{frame}

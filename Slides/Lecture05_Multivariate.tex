...
\begin{frame}{The VAR(1) Model}
  ...
  \[
    ...
    \end{cases}
  \]
  \begin{definitionbox}{VAR($p$) Model}
    {\small
    \[
      \mathbf{y}_t = \mathbf{c} + \mathbf{A}_1\mathbf{y}_{t-1}
                   + \cdots + \mathbf{A}_p\mathbf{y}_{t-p}
                   + \boldsymbol{\varepsilon}_t,
      \qquad \boldsymbol{\varepsilon}_t \overset{\mathrm{iid}}{\sim}
    ...
    \muted{\footnotesize\parencite{Sims1980}}
    }
  \end{definitionbox}
...
\begin{frame}{Granger Causality}
  \begin{definitionbox}{Granger Causality}
    ...
    \muted{\footnotesize\parencite{Granger1969}}}
  \end{definitionbox}
...
\begin{frame}{Regression with ARIMA Errors}
  Standard OLS forecasting (Lecture 2) assumes independent errors.
...
% --- Slide: VAR vs ARIMAX -----------------------------------------------------
\begin{frame}{VAR vs.\ ARIMAX: When to Use Each}
  \begin{center}
    {\small
    \begin{tabular}{lll}
      \toprule
  ...
  \begin{columns}[T]
    ...
    \column{0.44\textwidth}
      \begin{keybox}
        ...
        \parencite{EngleGranger1987,Hamilton1994}:\\[3pt]
